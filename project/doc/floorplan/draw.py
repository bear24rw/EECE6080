...
# to end of shifter
pin.add(dwg.line(start=(-slice_space/2, slice_height+slice_height*1/3.), end=(16*slice_width+06, slice_height+slice_height*1/3.), stroke="black"))
pin.add(dwg.line(start=(-slice_space/2, slice_height+slice_height*2/3.), end=(16*slice_width+03, slice_height+slice_height*2/3.), stroke="black"))

# coming out of shift right
pin.add(dwg.line(start=(16*slice_width, 2*slice_height+slice_height*1/3.), end=(16*slice_width+03, 2*slice_height+slice_height*1/3.), stroke="black"))
pin.add(dwg.line(start=(16*slice_width, 2*slice_height+slice_height*2/3.), end=(16.7*slice_width, 2*slice_height+slice_height*2/3.), stroke="black"))
...
# going over to PSO
pin.add(dwg.line(start=(16*slice_width, -14*(slice_height+slice_space)+slice_height/3.), end=(16.7*slice_width, -14*(slice_height+slice_space)+slice_height/3.), stroke="black"))

# comping out of shifter up
pin.add(dwg.line(start=(16*slice_width+03, 2*slice_height+slice_height*1/3.), end=(16*slice_width+03, slice_height+slice_height*2/3.), stroke="black"))
pin.add(dwg.line(start=(16*slice_width+06, 2*slice_height+slice_height*2/3.), end=(16*slice_width+06, slice_height+slice_height*1/3.), stroke="black"))


u = dwg.use(pin)
u.translate(-16*slice_width/2.0, 11*slice_height)
dwg.add(u)
